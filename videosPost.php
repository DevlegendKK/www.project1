...
function getPostDetailsBySlug($slug, $conn) {
    $stmt = $conn->prepare("SELECT id, title, description, featured_img, video_url, category, sub_category, tags, slug, content, author_id, published_at, modified_at, post_type, views FROM post WHERE slug = :slug AND status = :status LIMIT 1");
...
function getCommentsByPostId($post_id, $conn) {
    $stmt = $conn->prepare("SELECT id, userName, userEmail, comment, created_at, parent_comment_id FROM iv_postComments WHERE post_id = :post_id ORDER BY created_at DESC");
...
$baseImageUrl = "https://theindicvoice.com/assets/images/blog-post/";
...
<!-- Canonical URL -->
<link rel="canonical" href="https://theindicvoice.com/<?php echo htmlspecialchars($postDetails['post_type']); ?>/<?php echo htmlspecialchars($postDetails['slug']); ?>" />
...
<meta property="og:url" content="https://theindicvoice.com/<?php echo htmlspecialchars($postDetails['post_type']); ?>/<?php echo htmlspecialchars($postDetails['slug']); ?>" />
...
<meta name="twitter:creator" content="<?php echo !empty($authorDetails['twitter_handle']) ? '' . htmlspecialchars($authorDetails['twitter_handle']) : ''; ?>" />
...
<meta property="article:author" content="https://theindicvoice.com/author/<?php echo htmlspecialchars($authorDetails['slug']); ?>" />
...
<script type="application/ld+json">
{
  ...
  "image": "https://theindicvoice.com/assets/images/blog-post/<?php echo htmlspecialchars($postDetails['featured_img']); ?>",
  "author": {
    "@type": "Person",
  ...
  "publisher": {
    ...
    "logo": {
      "@type": "ImageObject",
      "url": "https://theindicvoice.com/assets/images/logo/logo.svg"
    }
  },
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://theindicvoice.com/<?php echo htmlspecialchars($postDetails['post_type']); ?>/<?php echo htmlspecialchars($postDetails['slug']); ?>"
  }
}
</script>
...
<script type="application/ld+json">
{
  ...
  "itemListElement": [
    ...
    },
    {
      ...
      "item": "https://theindicvoice.com/<?php echo htmlspecialchars($postDetails['category']); ?>/}"
    },
    {
      "@type": "ListItem",
      "position": 3,
      "name": "<?php echo htmlspecialchars($postDetails['title']); ?>",
      "item": "https://theindicvoice.com/<?php echo htmlspecialchars($postDetails['post_type']); ?>/<?php echo htmlspecialchars($postDetails['slug']); ?>"
    }
  ]
}
</script>
...
.ytp-show-cards-title, .ytp-chrome-top-buttons, .ytp-impression-link {display: none !important;}
        </style>
        ...
        <div class="iv-site-block">
            <div class="main-body">
                ...
                <div class="channel-banner">
                    <div class="video-container" style="position: relative; width: 100%; padding-bottom: 56.25%; /* 16:9 Aspect Ratio */">
                        <iframe src="<?php echo htmlspecialchars($postDetails['video_url']); ?>" 
                                frameborder="0" 
                                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
                                allowfullscreen 
                                style="position: absolute; top: 0; left: 0; width: 100%; height: 100%;">
                        </iframe>
                        <img src="https://theindicvoice.com/assets/images/blog-post/<?php echo htmlspecialchars($postDetails['featured_img']); ?>" 
                             alt="Video Thumbnail" 
                             style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; object-fit: cover; z-index: -1;">
                    </div>
                    <script>
                        const iframe = document.querySelector('iframe');
                        const thumbnail = document.querySelector('.video-container img');
                ...
                <div class="main-post-comments-toggle-wrap" id="main-post-comments-toggle-wrap comments">
                    <button class="btn btn-secondary btn-pill" id="main-post-comments-toggle">
                        <img src="https://nautil.us/wp-content/themes/nautilus-block-theme/images/icons/comment-plus.svg" alt="Comment Icon">
...
<style>.wp-block-group { box-sizing: border-box; margin-top: 20px; } .wp-block-group.is-layout-constrained { position: relative; } /* Styles for groups with background */ .wp-block-group.has-background { padding: 1.25em 2.375em; } /* Styles for flex layout groups */ .wp-block-group.is-layout-flex { display: flex; flex-wrap: nowrap; justify-content: flex-start; align-items: flex-end; } /* Styles for the spacer block */ .wp-block-spacer { height: 50px; width: 0px; visibility: hidden; } /* Styles for the heading block */ .wp-block-heading { font-family: var(--iv-font-heading); font-size: 2.566rem; font-weight: 600; line-height: 1.15; } .wp-block-heading a { color: #333; text-decoration: none; } .wp-block-heading a:hover { text-decoration: underline; } /* Styles for the separator block */ .wp-block-separator { border: none; border-bottom: 2px solid; margin-left: auto; margin-right: auto; } .wp-block-separator.has-alpha-channel-opacity { opacity: 1;margin-top:0; } .wp-block-separator.is-style-wide { width: 100%; } /* Container-specific styles */ .wp-container-core-group-is-layout-5 { flex-wrap: nowrap; justify-content: flex-start; align-items: flex-end; } .wp-container-core-group-is-layout-6 > :where(:not(.alignleft):not(.alignright):not(.alignfull)) { max-width: 1130px; margin-left: auto !important; margin-right: auto !important; } .wp-container-core-group-is-layout-6 > .alignwide { max-width: 1130px; } .wp-container-core-group-is-layout-6 .alignfull { max-width: none; } .wp-container-content-5, .wp-container-content-6 { flex-basis: 20px; }</style>
            ...
            <div class="floating-share-buttons">
                <a href="https://www.facebook.com/sharer/sharer.php?u=<?php echo urlencode("https://theindicvoice.com/{$postDetails['post_type']}/{$postDetails['slug']}"); ?>" target="_blank" class="share-button facebook">
                    <img src="/assets/images/icons/facebook-icon.svg" width="20px">
                </a>
                <a href="https://twitter.com/intent/tweet?url=<?php echo urlencode("https://theindicvoice.com/{$postDetails['post_type']}/{$postDetails['slug']}"); ?>&text=<?php echo urlencode($postDetails['title']); ?>" target="_blank" class="share-button twitter">
                    <img src="/assets/images/icons/twitter-icon.svg" width="20px">
                </a>
                <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo urlencode("https://theindicvoice.com/{$postDetails['post_type']}/{$postDetails['slug']}"); ?>&title=<?php echo urlencode($postDetails['title']); ?>" target="_blank" class="share-button linkedin">
                    <img src="/assets/images/icons/linkedin-icon.svg" width="20px">
                </a>
                <a href="https://wa.me/?text=<?php echo urlencode("Check this out: https://theindicvoice.com/{$postDetails['post_type']}/{$postDetails['slug']}"); ?>" target="_blank" class="share-button whatsapp">
